...
- Comfort Check now includes relative humidity and sensible heating/cooling rate outputs, exports metric-level completeness, and ranks zones by setpoint-band deviations.
