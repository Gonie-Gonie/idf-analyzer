...
func TestAnalyzeHVACPackagedTerminalUnitsUseCatalogForInternalComponents(t *testing.T) {
	tests := []struct {
		name          string
		objectType    string
	...
	}{
		{
			...
			equipmentName: "Office PTAC",
			fields: []Field{
				{Value: "Office PTAC"},
				{Value: "Always On"},
				{Value: "Office PTAC Return"},
				{Value: "Office PTAC Supply"},
				{Value: "OutdoorAir:Mixer"},
				{Value: "Office PTAC OA Mixer"},
				{Value: "Autosize"},
				{Value: "Autosize"},
				{Value: "Autosize"},
				{Value: ""},
				...
				{Value: "Autosize"},
				{Value: "Fan:OnOff"},
				{Value: "Office PTAC Fan"},
				{Value: "Coil:Heating:Electric"},
				{Value: "Office PTAC Heating Coil"},
				{Value: "Coil:Cooling:DX:SingleSpeed"},
				{Value: "Office PTAC Cooling Coil"},
				{Value: "DrawThrough"},
				{Value: "Always On"},
			},
			targets: []struct {
				...
				{objectType: "OutdoorAir:Mixer", name: "Office PTAC OA Mixer"},
				{objectType: "Fan:OnOff", name: "Office PTAC Fan"},
				{objectType: "Coil:Heating:Electric", name: "Office PTAC Heating Coil"},
				{objectType: "Coil:Cooling:DX:SingleSpeed", name: "Office PTAC Cooling Coil"},
			},
		},
		{
			name:          "PTHP",
			objectType:    "ZoneHVAC:PackagedTerminalHeatPump",
			equipmentName: "Office PTHP",
			fields: []Field{
				{Value: "Office PTHP"},
				{Value: "Always On"},
				{Value: "Office PTHP Return"},
				{Value: "Office PTHP Supply"},
				{Value: "OutdoorAir:Mixer"},
				{Value: "Office PTHP OA Mixer"},
				{Value: "0.4"},
				{Value: "0.4"},
				{Value: "Autosize"},
				{Value: ""},
				...
				{Value: "Office PTHP Fan"},
				{Value: "Coil:Heating:DX:SingleSpeed"},
				{Value: "Office PTHP Heating Coil"},
				{Value: "0.001"},
				{Value: "Coil:Cooling:DX:SingleSpeed"},
				{Value: "Office PTHP Cooling Coil"},
				{Value: "0.001"},
				{Value: "Coil:Heating:Electric"},
				{Value: "Office PTHP Supplemental Coil"},
				{Value: "50.0"},
				{Value: "10.0"},
				{Value: "BlowThrough"},
				{Value: "Always On"},
			...
			targets: []struct {
				...
				{objectType: "OutdoorAir:Mixer", name: "Office PTHP OA Mixer"},
				{objectType: "Fan:SystemModel", name: "Office PTHP Fan"},
				{objectType: "Coil:Heating:DX:SingleSpeed", name: "Office PTHP Heating Coil"},
				{objectType: "Coil:Cooling:DX:SingleSpeed", name: "Office PTHP Cooling Coil"},
				{objectType: "Coil:Heating:Electric", name: "Office PTHP Supplemental Coil"},
			},
		},
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			for index, target := range test.targets {
				objects = append(objects, Object{Index: 4 + index, Type: target.objectType, Fields: []Field{{Value: target.name}}})
			}

			report := AnalyzeHVAC(Document{Objects: objects})
			for _, target := range test.targets {
				if !hasHVACComponentReference(report.ComponentReferences, test.equipmentName, target.objectType, target.name, "internal_component_reference") {
					t.Fatalf("component references = %#v, want %s -> %s %s", report.ComponentReferences, test.equipmentName, target.objectType, target.name)
				}
			}
			relation := findHVACTestingZoneRelation(report, "Office")
			if relation == nil {
...
func TestAnalyzeHVACAirTerminalFamiliesUseCatalogWithoutComments(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:         "VAVHeatAndCoolNoReheat",
			objectType:   "AirTerminal:SingleDuct:VAV:HeatAndCool:NoReheat",
			terminalName: "Office VAV Heat Cool No Reheat",
			fields: []Field{
				{Value: "Office VAV Heat Cool No Reheat"},
				{Value: "Always On"},
				{Value: "Office Supply Inlet"},
				{Value: "Office Terminal Inlet"},
				{Value: "Autosize"},
		...
		{
			name:         "VAVHeatAndCoolReheat",
			objectType:   "AirTerminal:SingleDuct:VAV:HeatAndCool:Reheat",
			terminalName: "Office VAV Heat Cool Reheat",
			fields: []Field{
				{Value: "Office VAV Heat Cool Reheat"},
				{Value: "Always On"},
				{Value: "Office Damper Outlet"},
				{Value: "Office Terminal Inlet"},
				{Value: "Autosize"},
		...
		},
		{
			...
			fields: []Field{
				...
				{Value: "Office Supply Inlet"},
				{Value: "Office Reheat Coil Air Inlet"},
		...
		{
			name:         "FourPipeInduction",
			objectType:   "AirTerminal:SingleDuct:ConstantVolume:FourPipeInduction",
			terminalName: "Office Four Pipe Induction",
			fields: []Field{
				{Value: "Office Four Pipe Induction"},
				{Value: "Always On"},
				{Value: "Autosize"},
				{Value: "2.5"},
				{Value: "Office Terminal Inlet"},
				{Value: "Office Induced Inlet"},
				{Value: "Office Supply Inlet"},
				{Value: "Coil:Heating:Water"},
				{Value: "Office Heating Coil"},
				{Value: "Autosize"},
		...
		},
		{
			...
			terminalName: "Office Four Pipe Beam",
			fields: []Field{
				{Value: "Office Four Pipe Beam"},
				{Value: "Always On"},
				{Value: "Always On"},
				{Value: "Always On"},
				{Value: "Office Terminal Inlet"},
				{Value: "Office Supply Inlet"},
				{Value: "Office CHW Inlet"},
				{Value: "Office CHW Outlet"},
				{Value: "Office HW Inlet"},
				{Value: "Office HW Outlet"},
			},
			inlet:  "Office Terminal Inlet",
			outlet: "Office Supply Inlet",
		},
		{
			...
			terminalName: "Office User Terminal",
			fields: []Field{
				{Value: "Office User Terminal"},
				{Value: "Office User Terminal Model Manager"},
				{Value: "Office User Terminal Init Manager"},
				{Value: "Office Terminal Inlet"},
				{Value: "Office Supply Inlet"},
				{Value: "Office Secondary Inlet"},
				{Value: "Office Secondary Outlet"},
				{Value: "0"},
			},
			inlet:  "Office Terminal Inlet",
			outlet: "Office Supply Inlet",
